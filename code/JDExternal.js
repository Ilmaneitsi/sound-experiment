...
//To put in this patch. In hindsight I should have made this into a class.
...
//In TARGET the first 8 digits map the sample playback pointers and the last two
//Map playback direction and pitch (44 is regular playback)
...
//Bangs tell the first external to spit out the latest attempt at cracking
//the genome. In the subsequent externals it serves a different purpose.
function bang(){
  outlet(0,ATTEMPT);
}
...
function evolve(){
//if statement triggers the next sample/external to play
  if(getFitness(fittest)>6){
    outlet(1, "bang");
  }
